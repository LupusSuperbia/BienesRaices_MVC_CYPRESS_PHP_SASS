...
describe('Prueba la navegacion y Routing del header y Footer', () => {
    it('Prueba la navegacion del Header', () => {
        ...
        cy.get('[data-cy="navegacion-header"]').find('a').eq(2).invoke('attr', 'href').should('equal', '/blogs');
        cy.get('[data-cy="navegacion-header"]').find('a').eq(2).invoke('text').should('equal', 'Blogs');
    ...
    it('Prueba la navegacion del Footer', () => {
        ...
        cy.get('[data-cy="navegacion-footer"]').find('a').eq(2).invoke('attr', 'href').should('equal', '/blogs');
        cy.get('[data-cy="navegacion-footer"]').find('a').eq(2).invoke('text').should('equal', 'Blogs');
